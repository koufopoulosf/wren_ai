...
Handles dependency injection for core components only.
"""
...
class ComponentFactory:
    """
    Simplified factory for core components only.

    Creates only what's essential: SQL generation, classification,
    ...
    def create_pipeline_orchestrator(self) -> PipelineOrchestrator:
        ...
        Wires together only the essential components:
        - Question classifier
        - Response generator
        - SQL generator
        - Context manager
